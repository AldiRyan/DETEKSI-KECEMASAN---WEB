...
<body>
    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Aktivasi User</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                ...
                <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Form Aktivasi User</h6>
                    </div>
                    <div class="card-body col-6"> 
                        <form method="POST" class="col-12" action="<?= base_url('aktivasi_user/aktivasi_akun') ?>">
...
<script type="text/javascript">
    jQuery(function($){
        ...
        $("#type").change(function(){
            var val = $(this).val();
            $.ajax({
                url: base_url+"aktivasi_user/ambildata/"+val,
                type: "GET",
